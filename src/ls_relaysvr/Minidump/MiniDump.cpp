...
{
	Debug( "InvalidParameterHandler\n" );
	LOG.PrintTimeAndLog( LOG_DEBUG_LEVEL, "MINIDUMP - InvalidParameterHandler" );
}

void PurecallHandler(void)
{
	Debug( "PurecallHandler\n" );
	LOG.PrintTimeAndLog( LOG_DEBUG_LEVEL, "MINIDUMP - PurecallHandler" );
}
