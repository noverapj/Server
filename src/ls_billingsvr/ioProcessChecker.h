...
//	DWORD m_dwWorkLoop[WORKER_THREAD_COUNT];                // LogTime동안 IOCP WORK 루프 호출 횟수
...
//	void CallWorkThread( DWORD dwCount ){ m_dwWorkLoop[dwCount]++; }
...
public:
	...
	void MainServerSendMessage( int iSize );
