========================================================================
    Win32 응용 프로그램 : BillingRelayServer 프로젝트 개요
========================================================================

응용 프로그램 마법사에서 이 BillingRelayServer 응용 프로그램을 만들었습니다.  
이 파일에는 BillingRelayServer 응용 프로그램을 구성하는 각각의 파일에
들어 있는 요약 설명이 포함되어 있습니다.


BillingRelayServer.vcproj
...
BillingRelayServer.cpp
    기본 응용 프로그램 소스 파일입니다.

/////////////////////////////////////////////////////////////////////////////
응용 프로그램 마법사에서 다음 리소스를 만들었습니다.

BillingRelayServer.rc
    프로그램에서 사용하는 모든
...
BillingRelayServer.ico
    아이콘 파일이며, 응용 프로그램의 아이콘(32x32)으로 사용됩니다.
    해당 아이콘은 기본 리소스 파일인 BillingRelayServer.rc에 의해 포함됩니다.

small.ico
    아이콘 파일이며, 응용 프로그램 아이콘의 더 작은 버전(16x16)이
    들어 있습니다. 해당 아이콘은 기본 리소스 파일인
    BillingRelayServer.rc에 의해 포함됩니다.

/////////////////////////////////////////////////////////////////////////////
기타 표준 파일:

StdAfx.h 및 StdAfx.cpp는
    BillingRelayServer.pch라는 이름의 PCH(미리 컴파일된 헤더) 파일과
