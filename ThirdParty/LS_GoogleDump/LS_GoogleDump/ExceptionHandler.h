...
class ExceptionHandler {
 public:
  ...
  typedef bool (*MinidumpCallback)(const TCHAR* dump_path,
                                   const TCHAR* minidump_id,
                                   void* context,
 ...
 private:
  ...
  void Initialize(const string& dump_path,
                  FilterCallback filter,
                  MinidumpCallback callback,
                  void* callback_context,
                  int handler_types,
  ...
  // the above string versions are set in order to avoid calling c_str during
  ...
  // should be equivalent to the lifetimes of the associated string, provided
  // that the wstrings are not altered.
  const TCHAR* dump_path_c_;
  const TCHAR* next_minidump_id_c_;
  const TCHAR* next_minidump_path_c_;
